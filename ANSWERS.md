...
![Архитекрута](.images/architecture.png)
...
![Четырёхъядерный Skylake-S с графикой GT2](.images/processor.png)
...
![Микроархитектура](.images/arch1.png)
![Как примерно все расположено](.images/complex.png)
![Как примерно все расположено на кристалле](.images/core.png)
...
![Микроархитектура](.images/arch-56.png)
...
![Спецификации чипов семейства Turing](.images/Chip_Specifiation.png)
![Полный чип](.images/Chip_Full.png)
![Один кластер](.images/Cluster.png)
...
![Архитектура](.images/arch-72.png)
...
![Архитектура](.images/arch-73.png)
![SM](.images/SM-73.png)
![TC](.images/Tensor.png)
...
![Архитектура](.images/arch-74.png)
...
![Архиьтектура](.images/arch-75.png)
- 6 GPC
- 42 TPC
- 84 SM
...
![Тензорные ядра](.images/tensor-75.png)
